...
const Info = () => {
  return (
    <section className=" mt-[3rem] md:mt-[5rem] px-[25px]">
      <div className="max-w-[900px] mx-auto">
        ...
        <p className="font-bold mt-[2rem] text-[.8rem] md:text-[1rem]">
          Horario de atención del Centro de Visitantes Achala (y permanencia en
          estacionamiento N°1):
        </p>
        ...
        <ul className="list-disc list-inside mt-[1rem] text-[.8rem] md:text-[1rem] flex flex-col gap-4">
          ...
          <li>
            La <span className="font-bold">pesca recreativa</span> se encuentra
            habilitada desde el 30 octubre hasta fines de mayo. El permiso es
            obligatorio y se puede solicitar gratuitamente en
      ...
      <div className="max-w-[900px] mx-auto">
        ...
        <p className="text-[.8rem] md:text-[1rem]">
          Para acceder sin guía al Balcón Norte y/o el Río de los Condoritos es
          necesario completar un registro obligatorio.
          <br />
          <br />
          Lo completa un sólo responsable por grupo, realizando un registro por
          vehículo según la capacidad del mismo (entre 5 y 6 personas por auto)
          e incluyendo los datos de todos los acompañantes. El registro se
          realiza de manera virtual, a través de un formulario web.
          <br />
          <br />
          En caso de acceder en ómnibus u otro medio, se completa el registro
          hasta 6 personas por responsable (no repetir el nombre del responsable
          en más de un registro).
          <br />
          <br />
          Acompañantes: recordá presionar "confirmar acompañante" luego de
          cargar a cada uno, incluso el último; de lo contrario el sistema no lo
          guardará. Por último, presioná guardar y confirmar.
        </p>
        ...
        <p className="text-[.8rem] md:text-[1rem]">
          Para acceder al Balcón Sur o hacer trekking a campo traviesa tenés que
          contratar previo a la visita una excursión con guía habilitado.
          <br />
          <br />
      ...
      <div className="max-w-[900px] mx-auto flex flex-col gap-[3rem] md:gap-[5rem] my-[2rem] md:my-[3rem]">
        <div className="flex flex-col md:flex-row items-center gap-[1rem] bg-[#f7f7f7ff] md:bg-transparent p-[1rem] rounded-lg">
          <div className="md:flex-1 text-center md:text-left flex flex-col gap-[1rem] md:p-[1rem]">
            ...
            <p className="text-[.8rem] md:text-[1rem]">
              El Parque ofrece acampe libre, gratuito y agreste en las áreas La
              Cañada y Pampa Pajosa.
              <br />
              <br />
        ...
        <div className="flex flex-col md:flex-row items-center gap-[1rem] bg-[#f7f7f7ff] md:bg-transparent p-[1rem] rounded-lg">
          <div className="md:flex-1 text-center md:text-left flex flex-col gap-[1rem] md:p-[1rem] order-1 md:order-2">
            ...
            <p className="text-[.8rem] md:text-[1rem]">
              ...
              hasta el 28 de mayo de 2023. Sólo se puede pescar en temporada con{" "}
              <span className="font-bold">permiso</span>, gestionado por vía
              virtual.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-[1rem] bg-[#f7f7f7ff] md:bg-transparent p-[1rem] rounded-lg">
          <div className="md:flex-1 text-center md:text-left flex flex-col gap-[1rem] md:p-[1rem]">
            ...
            <p className="text-[.8rem] md:text-[1rem]">
              ...
              contratación de{" "}
              <span className="font-bold">guías habilitados</span> (incluye Luna
              Llena).
            </p>
          </div>
          <div className="md:flex-1 h-[300px] w-full md:h-[350px] relative">
      ...
      <div className="max-w-[900px] mx-auto border-b border-b-black pb-[2rem] md:pb-[3rem]">
        <h3 className="uppercase text-[1.5rem] md:text-[2rem] mb-[2rem] md:mb-[3rem] mt-[2rem] md:mt-[3rem] font-bold">
          Residuos
        </h3>

        <p className="text-[.8rem] md:text-[1rem]">
          Llevá siempre una bolsa (en lo posible color oscuro, no transparente)
          para ir dejando allí los residuos generados durante tu visita,
          incluyendo papel higiénico, pañales o apósitos femeninos, para ser
          retirados fuera del Parque y dispuestos en el sitio correspondiente.{" "}
          <span className="font-bold">
        ...
        <ul className="list-disc list-inside mt-[1rem] text-[.8rem] md:text-[1rem] flex flex-col gap-4 text-justify">
          ...
          <li>
            Se recomienda <span className="font-bold">cargar combustible</span>{" "}
            en Córdoba, Villa Carlos Paz o Mina Clavero, según el punto de
            acceso al Camino de las Altas Cumbres.
          </li>
          <li>
            Las únicas empresas de{" "}
            <span className="font-bold">transporte público</span> con parada en
            el Paraje La Pampilla (ingreso al área Noreste del Parque, por donde
            se llega caminando a la Quebrada del Condorito) son{" "}
          ...
          <li>
            Las respuestas a <span className="font-bold">consultas</span> sobre
            registros (incluyendo modificaciones de datos) tienen lugar
            únicamente de <span className="font-bold">lunes a viernes</span> de
            8 a 16 horas.
          </li>
        </ul>
      </div>
